...
proc create_root_design { parentCell } {
  ...
  set ld01_rgb [ create_bd_port -dir O -from 5 -to 0 ld01_rgb ]
  set ld2345 [ create_bd_port -dir O -from 3 -to 0 ld2345 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M01_AXI [get_bd_intf_pins PWM_0/PWM_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M02_AXI [get_bd_intf_pins PWM_1/PWM_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M02_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M06_AXI [get_bd_intf_pins PmodKYPD_0/AXI_LITE_GPIO] [get_bd_intf_pins microblaze_0_axi_periph/M06_AXI]
  ...
  connect_bd_net -net PWM_0_pwm [get_bd_ports ld01_rgb] [get_bd_pins PWM_0/pwm]
  connect_bd_net -net PWM_1_pwm [get_bd_ports ld2345] [get_bd_pins PWM_1/pwm]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins PmodOLEDrgb_0/ext_spi_clk] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins clk_wiz_0/clk_out1]
